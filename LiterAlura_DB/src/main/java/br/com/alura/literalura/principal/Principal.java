...
public class Principal {
    ...
    private void exibirMenu() {
        System.out.println("""
            ******************************************************************
            *                    LITERALURA                                  *
            *  Uma programa desenvolvido para você que gosta de livros !     *
            ...
            ******************************************************************
                       ...
                       6- Listar autores por ano de falecimento
                       7- Listar livros por um determinado idioma
                       0- Sair
            """);
    }
    ...
    private void listarLivrosPorIdioma() {
        ...
        if (livros.isEmpty()) {
            System.out.println("Não foi encontrado nenhum livro no idioma informado.");
        } else {
